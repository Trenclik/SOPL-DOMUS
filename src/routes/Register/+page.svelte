<script>
  ...
  <form on:submit|preventDefault={handleSubmit}>
    <Input label="Uživatelské jméno" type="text" value={username} onChange={(val) => (username = val)} />
    ...
    <Input label="Heslo" type="password" value={password} onChange={(val) => (password = val)} />
